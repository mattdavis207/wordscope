  ...
  useEffect(() => {
    const fetchCustomerEmail = async () => {
      ...
      if (email) {
        ...
        if (isPro) {
          // Communicate with extension instead of alert
          window.postMessage({
            type: 'PRO_ACTIVATED',
            email: email
          }, '*')
    ...
    <div className="min-h-screen bg-[#01122B] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative bg-[#072141] p-8 rounded-xl shadow-2xl max-w-md w-full text-center border border-[#374151] z-10">
        ...
        <div className="mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#BBE1FA] mb-2">Subscription Successful!</h2>
          <p className="text-[#9CA3AF] leading-relaxed mb-6">
            Thank you for supporting Wordscope. Your Pro features are now unlocked and ready to use.
          </p>
        </div>
